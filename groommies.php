...
// Set Main Var
$allitems = "SELECT * FROM `items` WHERE shop = 'Groommies' ORDER BY id";
...
echo '<img src="https://veeple.online/Images/groomies.png" alt="Groomies" class="headerlogo"></br>';
?>
<div class="stats" style="background-color: #8d8d8d;">
<?php
