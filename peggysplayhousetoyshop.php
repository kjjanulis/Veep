...
// Set Main Var
$allitems = "SELECT * FROM `items` WHERE shop = 'Peggys Play House' ORDER BY rand(" . date("Ymdh") . ") LIMIT $start_from, ".$results_per_page;
...
echo '<img src="https://veeple.online/Images/peggysplayhouse.png" alt="Peggys Playhouse" class="headerlogo"></br>';
?>
<div class="stats" style="background-color: #f7c5c5;">
<?php
