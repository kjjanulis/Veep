...
echo '<img src="https://veeple.online/Images/daycare.gif" alt="Veep Daycare" class="vologo"></br>';
if($daycare == 'yes'){
...
die();
	...
	<form id="daycare" name="daycare" method="post">
	  ...
	  <p>
	    <input name="submit" type="submit" id="submit" form="daycare" value="Send to Daycare" class="btn btn-primary">
	  </p>
</form>
<?php
if($debug == 1){
